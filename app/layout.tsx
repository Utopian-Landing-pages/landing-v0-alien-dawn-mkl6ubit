...
export const metadata: Metadata = {
  title: 'Alien Dawn - A Morally Complex Platformer',
  description: 'Compelling characters with morally gray aspects, diverse backstories, and unique personalities affecting gameplay. Experience a realistic, modern-day platformer with alien invasion themes.',
  generator: 'v0.app',
  keywords: ['platformer', 'alien invasion', 'moral choices', 'adult gaming', 'narrative-driven'],
  icons: {
    icon: [
      {
